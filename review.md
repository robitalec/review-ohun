...
I suggest moving packages under "Depends" to "Imports". 
The case of adding packages to the Depends field does not seem like a universal
yes/no clear cut decision. From my understanding and reading around this topic, 
I feel like for the `ohun` package, it is not necessary to include packages
...
In the case of `ohun`, some of the packages listed under Depends also list 
some packages under Depends:
